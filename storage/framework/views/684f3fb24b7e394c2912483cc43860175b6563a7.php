...
.form-signin input[type="password"] {
  ...
  border-top-right-radius: 0;
	...
	<form class="form-signin" action="<?php echo e(route('login')); ?>" method='post'>
	 ...
	 или
	  <form class="form-signin" action="<?php echo e(route('register')); ?>" method='post'>
		  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lavarel/laravelapp/resources/views/home.blade.php ENDPATH**/ ?>